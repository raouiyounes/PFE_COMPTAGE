...
// detection des points d'interet SURF
...
// calcul de l'ecart type de chaque ligne du descripteur
...
// le calcul de la moyenne de chaque ligne du descripteur
...
// ROWS nombre de lignes du descripteur
//COLS nombre de colonnes du descripteur
...
getline( ss,s,',');
cout<<atoi(s.c_str())<<"\n";
// stockage du descripteur dans l'attribut descriptors
